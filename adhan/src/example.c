...
int main(int argc, char *argv[]) {
  ...
  calculation_parameters_t calculation_parameters =
      new_calculation_parameters(15.0, 13.0);
  //    const calculation_parameters_t *calculation_parameters =
  ...
  //           0, _julianDay(dateComponents->year, dateComponents->month,
  //           dateComponents->day, 0.0));
  //
  ...
  for (int i = 1; i < 31; i++) {
    ...
    prayer_times_t prayer_times = new_prayer_times(
        &coordinates, &dateComponents, &calculation_parameters);
